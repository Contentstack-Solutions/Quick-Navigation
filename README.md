...
In the project directory, First you need to install module with Venus Storybook:
...
In the project directory, you can create minified file for Extension code :
### `npm run build`
### `gulp build`

Copy Minified Exyension code from my-app/build/index.html
